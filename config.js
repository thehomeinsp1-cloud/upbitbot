...
module.exports = {
  ...
  AUTO_TRADE: {
    ...
    // 🎯 조기 익절 + 트레일링 스탑 (v5.8.6 개선!)
    earlyProfit: {
      enabled: true,            // 조기 익절 활성화
      breakEvenAt: 2.5,         // 2.5% 수익 시 손절선을 본전으로 (1.5→2.5%)
      firstTakeAt: 3.0,         // 3% 도달 시 30% 부분 익절 (2→3%)
      firstTakeRatio: 0.3,      // 1차 익절 비율 (30%)
      // 나머지 70%는 트레일링 스탑으로 관리!
    },
    
    // 🚀 트레일링 스탑 (v5.8.6 개선!) - 수익 극대화!
    trailingStop: {
      enabled: true,            // 트레일링 스탑 활성화
      activateAt: 4,            // 4% 수익 시 트레일링 활성화 (3→4%)
      trailPercent: 4,          // 고점 대비 4% 하락 시 매도 (5→4% 타이트!)
      // 예: 진입가 100원
      // 1. 104원 (+4%) → 트레일링 활성화
      // 2. 120원 (+20%) → 고점 갱신
      // 3. 115.2원 (-4% from high) → 매도! (+15.2% 수익)
      
      // 🔥 대박 모드: 큰 수익 시 트레일 완화
      bigProfitAt: 15,          // 15% 수익 시 대박 모드 (20→15%)
      bigProfitTrail: 6,        // 대박 모드에서는 6% 하락까지 허용 (8→6%)
      // 예: +30% 수익 중 → 6% 하락해도 보유 → 더 큰 상승 추적
    },
